...
const AnnotationSubmitter = (props: AnnotationSubmitterProps) => {
  ...
  const annotationTypeDefinitions = [
    {value: 'Describing', motivation: 'describing', title: 'links external resources to the annotation'},
    ...
    <div className="App">
      <div className="container__app">
        ...
        <div className="addAnnotations">
          {motivation === "describing" && (<DescribingInput body={body} setBody={setBody} />)}
          {motivation === "linking" && (<LinkingInput body={body} setBody={setBody} />)}
          {motivation === "trompa:cueMedia" && (<CueMediaInput body={body} setBody={setBody} />)}
